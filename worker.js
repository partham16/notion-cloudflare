...
// READ : https://fruitionsite.com/
// for setting up your own website and serve
...
/* CONFIGURATION STARTS HERE */
  ...
  const PAGE_TITLE = 'Notion + Cloudflare : as a blog service';
  const PAGE_DESCRIPTION = 'A super simple way to publish personal pages / blogs using Notion as CMS and Cloudflare Workers as publisher';
  
  /* Step 4: enter a Google Font name, you can choose from https://fonts.google.com */
  const GOOGLE_FONT = 'Martel'; //'Roboto Mono';
  ...
  async function fetchAndApply(request) {
    ...
    let response;
    // seems to download the app...js file in sources
  ...
  // https://github.com/stephenou/fruitionsite/issues/58
  class BodyRewriter {
